...
class pyArgs :
    ...
    def __init__(self, specifications:list()):
        ...
        Args:
            ...
            Appending ! to argument indicates a required argument. 
            NOTE: the ! is stripped from the specifications and will NOT be included in the variable name
            NOTE: DO NOT include the ! when accessing values from self.args or specifying args in the command line (to the left of the =).
        """
    ...
    def parse(self):
        ...
        """
        i = 0
        while i < len(self._given) and i < 1024:
            if '=' in self._given[i]:
